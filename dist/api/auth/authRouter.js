...
function generateOpenAPIDocument() {
  const registry = new import_zod_to_openapi4.OpenAPIRegistry([healthCheckRegistry, authRegistry, mapCaptureRegistry]);
...
(0, import_zod_to_openapi5.extendZodWithOpenApi)(import_zod4.z);
...
// src/api/auth/authRouter.ts
var authRegistry = new import_zod_to_openapi6.OpenAPIRegistry();
